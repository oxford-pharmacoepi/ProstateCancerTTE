...
excluded_codes <- omopgenerics::importCodelist(path = here::here("..", "Codelist", "ExcludedFromPS"), type = "csv") |>
  unlist() |>
  unname()
cohorts <- c("optima_pc_rwd", "optima_pc_rwd_50_69", "optima_pc_rwd_70_inf", "optima_pc_rwd_2010_2020")
#cohorts <- c("optima_pc_rwd_50_69", "optima_pc_rwd_70_inf", "optima_pc_rwd_2010_2020", "optima_pc_rwd_50_69_2010_2020", "optima_pc_rwd_70_inf_2010_2020")
#c("optima_pc_trial", "optima_pc_rwd",)
...
#     })()
#
#   r <- omopgenerics::bind(result)
#
#   omopgenerics::exportSummarisedResult(r, path = output_directory, fileName = paste0("results_model_", cohort_name , "_{cdm_name}_{date}.csv"))
#
#
})
